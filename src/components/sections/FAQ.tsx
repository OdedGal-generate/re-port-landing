...
const faqItems = [
  {
    question: "עם אילו חברות ביטוח ובתי השקעות Re-PORT עובדת?",
    answer:
      "Re-PORT תומכת בכל חברות הביטוח ובתי ההשקעות בישראל עם חיבור אוטומטי מהיר ומאובטח.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "בממוצע, ההורדה האוטומטית לוקחת כ-1-2 דקות ללקוח — במקום 20 דקות ומעלה של הורדה, שליחה ותיוק ידנית. עבור לקוח עם מוצרים בחברות רבות, החיסכון אפילו גדול יותר.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "אין שום התחייבות ואין מנוי חודשי. אתם קונים בנקים של דוחות (למשל 100 דוחות) ומשתמשים בהם מתי שנוח לכם. 5 ₪ לדוח, ומ-600 דוחות ומעלה רק 4 ₪ לדוח. תשלום פשוט לפי שימוש.",
  },
];
